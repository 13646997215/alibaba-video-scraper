...
2. 按 `Ctrl+U` 打开源代码
3. `Ctrl+A` 全选并复制
4. 回到工具页粘贴到“浏览器辅助解析”输入框并执行解析

更省事的方式：

- “导入HTML文件”：在浏览器中保存网页为 HTML 文件后导入
- “一键书签脚本”：见 [help.html](help.html#bookmarklet)，在目标页点击书签即可自动导入并解析
